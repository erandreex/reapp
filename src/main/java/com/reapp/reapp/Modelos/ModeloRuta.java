...
public class ModeloRuta {
    ...
    public String getCategoria_ruta() {
        return categoria_ruta;
    }

    public void setCategoria_ruta(String categoria_ruta) {
        this.categoria_ruta = categoria_ruta;
    }

    public String getCategoria_icon() {
        return categoria_icon;
    }

    public void setCategoria_icon(String categoria_icon) {
        this.categoria_icon = categoria_icon;
    }

    public String getCategoria_color_1() {
        return categoria_color_1;
    }

    public void setCategoria_color_1(String categoria_color_1) {
        this.categoria_color_1 = categoria_color_1;
    }

    public String getCategoria_color_2() {
        return categoria_color_2;
    }

    public void setCategoria_color_2(String categoria_color_2) {
